...
##################### MAIN #####################
puerta = 0
print('Hay una puerta al norte y una llave en el suelo.')
print('\nPuedes ver tu inventario escribiendo: bolsa')

while True:

	opcion = input('coger llave, norte: ')

	#if opcion == 'coger llave' or 'coger estaca' or 'coger crucifijo':
	if opcion == 'coger llave':
		añadir_bolsa('llave_1') 
	
	elif opcion == 'norte': 
		if puerta == 1:
			print('Estas en el norte!')	
	
		elif abrir_puerta('llave_1'):		
			eliminar_bolsa('llave_1')
			puerta = 1
